...
import { DashboardSlugPage } from "../components/dashboard/products/DashboardSlugPage";
    ...
    },
    {
        ...
        children:[
            ...
            },
            {
                ...
                element:<DashboardSlugPage></DashboardSlugPage>
            },
            {
                path:"ordenes",
                element:<DashboardOrdersPage></DashboardOrdersPage>
            },
            {
                path:"ordenes/:id",
